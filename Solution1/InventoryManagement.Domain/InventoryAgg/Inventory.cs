...
namespace InventoryManagement.Domain.InventoryAgg
{
    public class Inventory: EntityBase
    {
        ...
        public void Increase(long count, long operatorId, string description)
        {
            ...
            var operation = new InventoryOperation(true, operatorId, count, currentCount, description,
                0, Id);
        ...
        {
            var currentCount = CalculateCurrentCount() - count;
            var operation = new InventoryOperation(false, operatorId, count, currentCount,
        ...
        public class InventoryOperation 
        {
            ...
            public InventoryOperation(bool operation, long operatorId, 
                long count, long currentCount, string description, 
